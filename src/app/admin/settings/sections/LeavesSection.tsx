      ...
      <section className="rounded-3xl border border-blue-100 bg-white/85 p-5 shadow-inner shadow-blue-100/50">
        ...
        <div className="mt-3 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          <div>
            ...
            <select
              ...
              className={`mt-1 form-input ${isReadOnly ? 'cursor-not-allowed opacity-60' : ''}`}
              disabled={isReadOnly}
            >
              {employees.length === 0 ? (
          ...
          <div className="md:col-span-2">
            ...
            <textarea
              ...
              className={`mt-1 form-input min-h-[80px] ${isReadOnly ? 'cursor-not-allowed opacity-60' : ''}`}
          ...
          <div className="md:col-span-2">
            ...
            <textarea
              ...
              className={`mt-1 form-input min-h-[60px] ${isReadOnly ? 'cursor-not-allowed opacity-60' : ''}`}
        ...
        <div className="mt-4 flex items-center gap-3">
          <button
            ...
            disabled={isSaving || employees.length === 0 || isReadOnly}
            className={`inline-flex items-center justify-center rounded-2xl bg-gradient-to-r from-indigo-600 via-sky-500 to-blue-500 px-4 py-2 text-sm font-semibold text-white shadow-[0_20px_60px_-45px_rgba(37,99,235,1)] transition hover:shadow-[0_24px_70px_-50px_rgba(37,99,235,1)] disabled:cursor-not-allowed disabled:opacity-70 ${isReadOnly ? 'opacity-50' : ''}`}
          >
            บันทึกวันลา
          </button>
          <button
                ...
                <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                  ...
                  <div className="flex flex-col items-start gap-2 md:items-end">
                    <select
                      ...
                      className={`form-input text-xs ${isReadOnly ? 'cursor-not-allowed opacity-60' : ''}`}
                    >
                    ...
                    <button
                      ...
                      disabled={isReadOnly}
                      className={`rounded-full border border-red-200 px-3 py-1 text-xs font-semibold text-red-600 hover:bg-red-50 disabled:cursor-not-allowed disabled:opacity-50 ${isReadOnly ? 'opacity-50' : ''}`}
                    >
                      ลบ
                    </button>
                  </div>
